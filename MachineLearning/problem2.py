...
# Naive Bayes Classifier with 85% - train and 15% - test
# PRINT: accuracy, class, probabilities
if __name__ == '__main__':
    ...
    #Divide into characteristics and class, convert to float
    ...
    predict_sample = classifier.predict([sample])[0]
    probabilities_sample = classifier.predict_proba([sample])
